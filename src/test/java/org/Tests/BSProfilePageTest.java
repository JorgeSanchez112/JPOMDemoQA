...
public class BSProfilePageTest extends TestBase {
    ...
    public void initializeClass(){
        ...
        bsProfilePage = homePage.clickOnSectionBookStoreApplication(getDriver()).clickOnProfile(getDriver());
    ...
    public void isUsernameCorrect() {
        ...
        bsProfilePage.clickOnLoginLink().userLogin(USERNAME,PASSWORD,getDriver());
